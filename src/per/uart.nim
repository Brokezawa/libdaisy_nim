...
proc startLog*(waitForPc: bool = false) {.inline.} =
  ...
  ## 
  ## Parameters:
  ##   waitForPc: If true, blocks until a terminal is connected
  ## 
  ## Example:
  ## ```nim
  ## startLog()  # Start immediately
  ## # or
...
proc printf*(format: cstring) {.varargs, importcpp: "daisy::Logger<daisy::LOGGER_INTERNAL>::Print(@)",
                                 header: "hid/logger.h".}
  ## Printf-style formatted printing
  ## 
  ## Example:
