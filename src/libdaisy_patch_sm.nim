...
useDaisyModules(patch_sm, codec_pcm3060)
...
type
  ...
  DaisyPatchSM* {.importcpp: "daisy::patch_sm::DaisyPatchSM".} = object
    ...
    adc*: libdaisy.AdcHandle        ## 12-channel ADC (8 CV + 4 aux)
    usb*: UsbHandle                 ## USB peripheral
    codec*: Pcm3060                 ## PCM3060 audio codec
    dac*: libdaisy.DacHandle        ## 2-channel DAC for CV outputs
    user_led*: GPIO                 ## Onboard user LED
    controls*: ptr AnalogControl ## Array of 12 analog controls
