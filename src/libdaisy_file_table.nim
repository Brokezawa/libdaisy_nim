...
##
## .. code-block:: nim
##    import libdaisy_file_table
##    import libdaisy_sdmmc
##    
...
## See Also
## --------
## - `libdaisy_sdmmc <libdaisy_sdmmc.html>`_ - SD card access
## - `libdaisy_qspi <libdaisy_qspi.html>`_ - QSPI flash access
## - FatFs documentation - Underlying filesystem library

import libdaisy
import libdaisy_macros

useDaisyModules(file_table)
...
type
  FileTable*[max_slots: static csize_t] {.
...
proc clear*[N: static csize_t](this: var FileTable[N]) {.importcpp: "#.Clear()".}
...
proc fill*[N: static csize_t](this: var FileTable[N], path: cstring,
...
proc writeLog*[N: static csize_t](this: var FileTable[N],
...
proc isFileInSlot*[N: static csize_t](this: FileTable[N], idx: csize_t): bool {.
...
proc getFileSize*[N: static csize_t](this: FileTable[N], idx: csize_t): csize_t {.
...
proc getFileName*[N: static csize_t](this: FileTable[N], idx: csize_t): cstring {.
...
proc getNumFiles*[N: static csize_t](this: FileTable[N]): csize_t {.
...
proc isLoadPending*[N: static csize_t](this: FileTable[N]): bool {.
...
proc clearLoadPending*[N: static csize_t](this: var FileTable[N]) {.
  importcpp: "#.ClearLoadPending()".}
  ## Clear the load pending flag.

proc setLoadPending*[N: static csize_t](this: var FileTable[N], slot: cint) {.
...
proc isSavePending*[N: static csize_t](this: FileTable[N]): bool {.
  importcpp: "#.IsSavePending()".}
  ## Check if a save operation is pending.
  ##
  ## **Returns:** True if save pending, false otherwise

proc clearSavePending*[N: static csize_t](this: var FileTable[N]) {.
  importcpp: "#.ClearSavePending()".}
  ## Clear the save pending flag.

proc setSavePending*[N: static csize_t](this: var FileTable[N], slot: cint) {.
...
proc getSlotForSaveLoad*[N: static csize_t](this: FileTable[N]): cint {.
...
iterator items*[N: static csize_t](table: FileTable[N]): tuple[idx: int, name: cstring, size: int] =
...
proc printTable*[N: static csize_t](table: FileTable[N]) =
...
proc findByName*[N: static csize_t](table: FileTable[N], searchName: cstring): int =
