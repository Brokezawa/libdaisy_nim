...
import libdaisy_switch
import libdaisy_led
import libdaisy_rgbled
import dev/leddriver

export libdaisy_switch  # Export Switch methods
export leddriver  # Export LED driver methods

useDaisyModules(petal)
...
type
  ...
  DaisyPetal* {.importcpp: "daisy::DaisyPetal".} = object
    ...
    switches*: array[7, libdaisy_switch.Switch]   ## 7 switches (4 footswitches + 3 toggles)
...
# Audio callback type aliases (from libdaisy)
type
