...
{.push header: "util/WavPlayer.h".}

import libdaisy_macros

# Ensure headers are included
emitWavPlayerIncludes()
...
type
  WavPlayerResult* {.importcpp: "daisy::WavPlayer<4096>::Result", pure.} = enum
    ...
    PrepareOverrun = "daisy::WavPlayer<4096>::Result::PrepareOverrun"
    NewSamplesRequested = "daisy::WavPlayer<4096>::Result::NewSamplesRequested"
    DiskError = "daisy::WavPlayer<4096>::Result::DiskError"
...
proc durationSeconds*(player: WavPlayer4K): float {.inline.} =
  ...
  let sampleRate = 48000.0  # TODO: Get from file info
