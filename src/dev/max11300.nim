...
proc defaults*(config: var MAX11300TransportConfig) =
  ...
  {.emit: "`config`.periph = daisy::SpiHandle::Config::Peripheral::SPI_1;".}
  {.emit: "`config`.baud_prescaler = daisy::SpiHandle::Config::BaudPrescaler::PS_8;".}
