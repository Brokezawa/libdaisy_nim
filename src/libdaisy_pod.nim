...
import libdaisy_midi

export libdaisy_rgbled  # Export RgbLed methods for user convenience
...
type
  ...
  DaisyPod* {.importcpp: "daisy::DaisyPod".} = object
    ...
    knobs*: ptr AnalogControl   ## Array of knobs [KNOB_1, KNOB_2]
    button1*: Switch            ## Left tactile button
    button2*: Switch            ## Right tactile button
    buttons*: ptr Switch        ## Array of buttons [BUTTON_1, BUTTON_2]
