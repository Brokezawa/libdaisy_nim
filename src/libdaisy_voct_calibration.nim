...
##
## .. code-block:: nim
##    import libdaisy_voct_calibration
...
## See Also
## --------
## - `libdaisy_persistent_storage <libdaisy_persistent_storage.html>`_ - Save calibration data
## - `examples/voct_tuning.nim` - Complete OLED-guided calibration example
## - `libdaisy_adc <libdaisy_adc.html>`_ - Read CV inputs

import libdaisy
import libdaisy_macros
import std/math  # For pow() in frequency conversion

useDaisyModules(voct)
